public static class CommandKeys
{
    ...
    public const string LoginRequest = "LgRq_#@!"; // Запрос на вход в игру
    public const string RegistrationRequest = "RgRq_#@!"; // Запрос на регистрацию
    public const string Separator = ":"; // Сепаратор
    public const string SuccessfulLogin = "LgSc_#@!"; // Успешный вход
    public const string SuccessfulRegistration = "RgSc_#@!"; // Успешная регистрация
}
